  ...
  <header id="header">
    <div class="container">
      ...
      <div id="logo" class="pull-left">
        ...
        <a href="index.php" class="scrollto"><img src="assets\img\logo2.png" alt="Whistle Media" title="Whistle Media"></img></a>
      </div>
      ...
      <nav id="nav-menu-container">
        <ul class="nav-menu">
          ...
          <li><a href="#supporters">Services</a></li>
          <li class="buy-tickets"><a href="#contact">Contact</a></li>
       <!--    <li class="buy-tickets"><a href="#buy-tickets">Xyz</a></li> -->
        </ul>
...
Do watch and share the inspirational story of these super women from choral.
    ...
    <iframe class="embed-responsive-item" src="https://www.youtube.com/embed/t5kUZsC3-dw"></iframe>
              ...
              <div class="details">
                <h3><a href="#">Meera Neuro Center</a></h3>
                <p>Adverticement</p>
                </div>
            </div>
          </div>
    ...
    <section id="gallery">
      ...
      <div class="container" data-aos="fade-up">
        <div class="section-header">
          <h2>Pandamic Special</h2>
          <p>Check our work from Lockdown</p>
        </div>
      </div>
        ...
        <div class="row contact-info">
          ...
          <div class="col-md-4">
            <div class="contact-phone">
              ...
              <h3>Phone Number</h3>
              <p><a href="tel:+919806580807">+91 9806580807</a></p>
            </div>
          </div>
...
<!-- 
          <div class="col-lg-3 col-md-6 footer-info">
            ...
            <p>A place for all your video production and media solutions 🎥
we make all kinds of videos</p>
          </div>
 -->
  ...
  <div class="col-lg-3 col-md-6 footer-links"></div>
          <div class="col-lg-3 col-md-6 footer-contact">
            ...
            <div class="social-links">
              <a href="https://twitter.com/WhistleMedia1" class="twitter"><i class="fa fa-twitter"></i></a>
              <a href="https://www.facebook.com/WhistleMedia/" class="facebook"><i class="fa fa-facebook"></i></a>
              <a href="https://www.instagram.com/whistle_media/" class="instagram"><i class="fa fa-instagram"></i></a>
    ...
    <div class="container">
      <div class="copyright">
        &copy; Copyright <strong>@Whistle Media</strong>. All Rights Reserved
      </div>
      <div class="credits">
        <!--
